      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed font-medium">
              Bringing the world's best flavors right to your doorstep. Fast,
              fresh, and handled with care. Your cravings, delivered.
            </p>
          ...
          <div className="lg:pl-10">
            <h3 className="text-lg font-black text-white mb-6 uppercase tracking-widest border-b border-amber-500 w-fit">
              Company
            </h3>
            ...
            <ul className="space-y-3">
              {companyLinks.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className="text-slate-400 hover:text-amber-500 transition-all duration-300 flex items-center group font-medium"
                  >
                    <span className="w-0 group-hover:w-4 transition-all duration-300 h-[2px] bg-amber-500 mr-0 group-hover:mr-2"></span>
                    {item.name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <a
                    href="#"
                    className="text-slate-400 hover:text-amber-500 transition-colors flex items-center group font-medium"
                  >
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-500 text-xs font-medium">
            &copy; 2026 <span className="text-white">KindBite</span>. Made with
            ❤️ for food lovers.
          </p>
          ...
          <div className="flex gap-4">
            <motion.button
              whileHover={{ y: -2 }}
              className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-tighter hover:bg-white/10"
            >
              App Store
            </motion.button>
            <motion.button
